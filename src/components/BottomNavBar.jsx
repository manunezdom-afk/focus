...
export default function BottomNavBar({ activeView, onNavigate }) {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 w-full z-50 flex justify-around items-center px-2 pt-3 bg-slate-50/70 backdrop-blur-2xl border-t border-slate-200/50"
